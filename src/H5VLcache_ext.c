...
static herr_t H5VL_cache_ext_attr_specific(void *obj, const H5VL_loc_params_t *loc_params, H5VL_attr_specific_args_t *args, hid_t dxpl_id, void **req);
...
static herr_t H5VL_cache_ext_dataset_get(void *dset, H5VL_dataset_get_args_t *args, hid_t dxpl_id, void **req);
static herr_t H5VL_cache_ext_dataset_specific(void *obj, H5VL_dataset_specific_args_t *args, hid_t dxpl_id, void **req);
static herr_t H5VL_cache_ext_dataset_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id, void **req);
...
static herr_t H5VL_cache_ext_datatype_get(void *dt, H5VL_datatype_get_args_t *args, hid_t dxpl_id, void **req);
static herr_t H5VL_cache_ext_datatype_specific(void *obj, H5VL_datatype_specific_args_t *args, hid_t dxpl_id, void **req);
static herr_t H5VL_cache_ext_datatype_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id, void **req);
...
static herr_t H5VL_cache_ext_file_specific(void *file, H5VL_file_specific_args_t *args, hid_t dxpl_id, void **req);
...
static herr_t H5VL_cache_ext_group_specific(void *obj, H5VL_group_specific_args_t *args, hid_t dxpl_id, void **req);
...
/* Link callbacks */
static herr_t H5VL_cache_ext_link_create(H5VL_link_create_args_t *args, void *obj, const H5VL_loc_params_t *loc_params, hid_t lcpl_id, hid_t lapl_id, hid_t dxpl_id, void **req);
...
static herr_t H5VL_cache_ext_link_get(void *obj, const H5VL_loc_params_t *loc_params, H5VL_link_get_args_t *args, hid_t dxpl_id, void **req);
static herr_t H5VL_cache_ext_link_specific(void *obj, const H5VL_loc_params_t *loc_params, H5VL_link_specific_args_t *args, hid_t dxpl_id, void **req);
static herr_t H5VL_cache_ext_link_optional(void *obj, const H5VL_loc_params_t *loc_params, H5VL_optional_args_t *args, hid_t dxpl_id, void **req);
...
static herr_t H5VL_cache_ext_object_get(void *obj, const H5VL_loc_params_t *loc_params, H5VL_object_get_args_t *args, hid_t dxpl_id, void **req);
static herr_t H5VL_cache_ext_object_specific(void *obj, const H5VL_loc_params_t *loc_params, H5VL_object_specific_args_t *args, hid_t dxpl_id, void **req);
static herr_t H5VL_cache_ext_object_optional(void *obj, const H5VL_loc_params_t *loc_params, H5VL_optional_args_t *args, hid_t dxpl_id, void **req);
...
static herr_t create_file_cache_on_local_storage(void *obj, void *file_args, void **req);
static herr_t create_group_cache_on_local_storage(void *obj, void *group_args, void **req);
static herr_t create_dataset_cache_on_local_storage(void *obj, void *dset_args, void **req);
...
static herr_t create_file_cache_on_global_storage(void *obj, void *file_args, void **req);
static herr_t create_group_cache_on_global_storage(void *obj, void *group_args, void **req);
static herr_t create_dataset_cache_on_global_storage(void *obj, void *dset_args, void **req);
 ...
 */
static herr_t
H5VL_cache_ext_attr_get(void *obj, H5VL_attr_get_args_t *args, hid_t dxpl_id,
    void **req)
{
    H5VL_cache_ext_t *o = (H5VL_cache_ext_t *)obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_cache_ext_attr_optional(void *obj, H5VL_optional_args_t *args,
    hid_t dxpl_id, void **req)
{
    H5VL_cache_ext_t *o = (H5VL_cache_ext_t *)obj;
    herr_t ret_value;
    ...
    hid_t dcpl_id, hid_t dapl_id, hid_t dxpl_id, void **req)
{
	...
	if (o->write_cache || o->read_cache) {
	  ...
	  dset->H5LS->cache_io_cls->create_dataset_cache((void*)dset, (void *)args, req);
	}
...
H5VL_cache_ext_dataset_mmap_remap(void *obj) {
  ...
  if (strcmp(dset->H5LS->type, "MEMORY")!=0) {
...
#ifdef __linux__
    if (dset->H5DRMM->mpi->rank==io_node() && debug_level()>1) printf(" [CACHE VOL] hint drop caches\n");
    ...
    double t1 = MPI_Wtime();
    if (dset->H5DRMM->mpi->rank==io_node() && debug_level()>1) printf(" [CACHE VOL] close the files, remove the caches\n");
    char tmp[252];
    ...
    double t2 = MPI_Wtime();
    if (dset->H5DRMM->mpi->rank==io_node() && debug_level()>1) printf(" [CACHE VOL] Remap time: %6.2f(rm) %6.2f(re)\n", t1-t0, t2-t1);
    ...
    const char *name, hid_t dapl_id, hid_t dxpl_id, void **req)
{
	...
	args->type_id = dataset_get_type(dset->under_object, dset->under_vol_id, dxpl_id, NULL);
	args->space_id = dataset_get_space(dset->under_object, dset->under_vol_id, dxpl_id, NULL);
	args->dcpl_id = dataset_get_dcpl(dset->under_object, dset->under_vol_id, dxpl_id, NULL);
...
H5VL_cache_ext_dataset_prefetch(void *obj, hid_t fspace, hid_t plist_id, void **req) {
  ...
  if (dset->read_cache) {
    ...
    printf(" [CACHE VOL] HDF5_CACHE_RD is not set, doing nothing here for dataset_prefetch\n");
    return 0;
  }
}
    ...
    hid_t file_space_id, hid_t plist_id, void *buf, void **req)
{
    ...
    if (o->read_cache)
      o->H5LS->cache_io_cls->write_data_to_cache2(dset, mem_type_id, mem_space_id, file_space_id, plist_id, buf, req);
    if(req && *req)
      *req = H5VL_cache_ext_new_obj(*req, o->under_vol_id);
    return ret_value;
    ...
    hid_t file_space_id, hid_t plist_id, void *buf, void **req)
{
	...
	ret_value = o->H5LS->cache_io_cls->read_data_from_cache(dset, mem_type_id, mem_space_id, file_space_id, plist_id, buf, req);
    }
    else {
      ret_value = H5VLdataset_read(o->under_object, o->under_vol_id, mem_type_id, mem_space_id, file_space_id, plist_id, buf, req);
    }
...
free_cache_space_from_dataset(void *dset, hsize_t size) {
  ...
  if (o->H5DWMM->cache->mspace_per_rank_total < size) {
    printf(" [CACHE VOL] Size of the dataset to be writen exceeds the size of the NLS\n");
    return FAIL;
  }
  ...
  if (o->H5DWMM->mmap->offset + size > o->H5DWMM->cache->mspace_per_rank_total) {
	...
	printf(" [CACHE VOL] request wait(jobid: %d), current available space: %10.5f \n", o->H5DWMM->io->current_request->id, available);
	...
	printf(" [CACHE VOL] **Task %d finished\n", o->H5DWMM->io->current_request->id);
      ...
      available = available + (o->H5DWMM->io->current_request->size/PAGESIZE+1)*PAGESIZE;
      if (debug_level()>2 && io_node()==o->H5DWMM->mpi->rank)
	printf(" [CACHE VOL] request wait(jobid: %d), current available space: %10.5f \n", o->H5DWMM->io->current_request->id, available);
  ...
  if (o->H5DWMM->mpi->rank==io_node() && debug_level()>1)
    printf(" [CACHE VOL] free_space_from_dataset (after): o->H5DWMM->cache->mspace_per_rank_left, size: %llu, %llu\n", o->H5DWMM->cache->mspace_per_rank_left, size);
  if (o->H5DWMM->cache->mspace_per_rank_left >= size)
    return SUCCEED;
  else
    return FAIL;
...
add_current_write_task_to_queue(void *dset, hid_t mem_type_id, hid_t mem_space_id,
  ...
  o->H5DWMM->io->request_list->buf = o->H5LS->cache_io_cls->write_data_to_cache(dset, mem_type_id, mem_space_id, file_space_id, plist_id, buf, NULL);
  ...
  if (debug_level()>1 && io_node() == o->H5DWMM->mpi->rank)
    printf(" [CACHE VOL] offset, mspace_per_rank_left, mspace_per_rank_total: %llu, %llu, %llu\n",
    ...
    hid_t file_space_id, hid_t plist_id, const void *buf, void **req)
{
	...
	printf(" [CACHE VOL] **WARNING: Directly writing data to the storage layer below\n");
 ...
 */
static herr_t
H5VL_cache_ext_dataset_get(void *dset, H5VL_dataset_get_args_t *args,
    hid_t dxpl_id, void **req)
{
    H5VL_cache_ext_t *o = (H5VL_cache_ext_t *)dset;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_cache_ext_dataset_optional(void *obj, H5VL_optional_args_t *args,
    hid_t dxpl_id, void **req)
{
    H5VL_cache_ext_t *o = (H5VL_cache_ext_t *)obj;
    herr_t ret_value;
    ...
    if(args->op_type == H5VL_cache_dataset_prefetch_op_g) {
        ...
        ret_value = H5VL_cache_ext_dataset_read_to_cache(obj, opt_args->mem_type_id, opt_args->mem_space_id, opt_args->file_space_id, dxpl_id, opt_args->buf, req);
	...
	ret_value = o->H5LS->cache_io_cls->read_data_from_cache(obj, opt_args->mem_type_id, opt_args->mem_space_id, opt_args->file_space_id, dxpl_id, opt_args->buf, req);
    } else if (args->op_type == H5VL_cache_dataset_mmap_remap_op_g) {
        if (o->read_cache) {
            if (o->H5DRMM->mpi->rank==io_node() && debug_level()>1) printf(" [CACHE_VOL] mmap_remap\n");
      ...
      ret_value = o->H5LS->cache_io_cls->remove_dataset_cache(obj, req);
        ...
        dset_args.type_id = dataset_get_type(o->under_object, o->under_vol_id, H5P_DATASET_XFER_DEFAULT, NULL);
        dset_args.space_id = dataset_get_space(o->under_object, o->under_vol_id, H5P_DATASET_XFER_DEFAULT, NULL);
        dset_args.dcpl_id = dataset_get_dcpl(o->under_object, o->under_vol_id, H5P_DATASET_XFER_DEFAULT, NULL);
        dset_args.dapl_id = dataset_get_dapl(o->under_object, o->under_vol_id, H5P_DATASET_XFER_DEFAULT, NULL);
...
H5VL_cache_ext_dataset_wait(void *dset) {
  ...
  H5VLget_value(o->under_vol_id, &under_value);
  if (under_value != H5VL_ASYNC_VALUE) {
    printf(" [CACHE_VOL] Do not have Async VOL underneath it, no async process\n");
    return SUCCEED;
  }
  ...
  if (o->write_cache) {
    ...
    while((o->num_request_dataset > 0) && (o->H5DWMM->io->current_request != NULL)) {
      double t0 = MPI_Wtime();
      H5VLrequest_wait(o->H5DWMM->io->current_request->req, o->under_vol_id, INF, &status);
      if(o->H5DWMM->io->current_request->buf!=NULL && !(strcmp(o->H5LS->scope, "GLOBAL"))) {
...
H5VL_cache_ext_file_wait(void *file) {
  ...
  H5VLget_value(o->under_vol_id, &under_value);
  if (under_value != H5VL_ASYNC_VALUE) {
    printf(" [CACHE VOL] Do not have Async VOL underneath it, no async process\n");
    return SUCCEED;
  }
 ...
 */
static herr_t
H5VL_cache_ext_datatype_get(void *dt, H5VL_datatype_get_args_t *args,
    hid_t dxpl_id, void **req)
{
 ...
 */
static herr_t
H5VL_cache_ext_datatype_optional(void *obj, H5VL_optional_args_t *args,
    hid_t dxpl_id, void **req)
{
    H5VL_cache_ext_t *o = (H5VL_cache_ext_t *)obj;
    herr_t ret_value;
 ...
 */
static herr_t
set_file_cache(void *obj, void *file_args, void **req) {
  H5VL_cache_ext_info_t *info;
  ...
  if (file->read_cache || file->write_cache) {
    herr_t ret = file->H5LS->cache_io_cls->create_file_cache(obj, file_args, req);
    return ret;
  }
  return SUCCEED;
}
 ...
 */
static herr_t
H5VL_cache_ext_file_get(void *file, H5VL_file_get_args_t *args, hid_t dxpl_id,
    void **req)
{
    H5VL_cache_ext_t *o = (H5VL_cache_ext_t *)file;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_cache_ext_file_specific(void *file, H5VL_file_specific_args_t *args,
    hid_t dxpl_id, void **req)
{
    H5VL_cache_ext_t *o = (H5VL_cache_ext_t *)file;
 ...
 */
static herr_t
H5VL_cache_ext_file_optional(void *file, H5VL_optional_args_t *args,
    hid_t dxpl_id, void **req)
{
    H5VL_cache_ext_t *o = (H5VL_cache_ext_t *)file;
    herr_t ret_value;
    ...
    hid_t dxpl_id, void **req)
{
	...
	if (group->write_cache || group->read_cache) {
	  ...
	  args->dxpl_id = dxpl_id;
	  group->H5LS->cache_io_cls->create_group_cache((void*)group, (void *)args, req);
	}
        /* Check for async request */
        if(req && *req)
            *req = H5VL_cache_ext_new_obj(*req, o->under_vol_id);
 ...
 */
static herr_t
H5VL_cache_ext_group_get(void *obj, H5VL_group_get_args_t *args, hid_t dxpl_id,
    void **req)
{
    H5VL_cache_ext_t *o = (H5VL_cache_ext_t *)obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_cache_ext_group_specific(void *obj, H5VL_group_specific_args_t *args,
    hid_t dxpl_id, void **req)
{
    H5VL_cache_ext_t *o = (H5VL_cache_ext_t *)obj;
 ...
 */
static herr_t
H5VL_cache_ext_group_optional(void *obj, H5VL_optional_args_t *args,
    hid_t dxpl_id, void **req)
{
    H5VL_cache_ext_t *o = (H5VL_cache_ext_t *)obj;
    herr_t ret_value;
 ...
 */
static herr_t
H5VL_cache_ext_link_create(H5VL_link_create_args_t *args, void *obj,
 ...
 */
static herr_t
H5VL_cache_ext_link_optional(void *obj, const H5VL_loc_params_t *loc_params,
    ...
    H5I_type_t *opened_type, hid_t dxpl_id, void **req)
{
	...
	if (*opened_type==H5I_GROUP) { // if group is opened
	  ...
	  if (called && (new_obj->read_cache || new_obj->write_cache)) {
	    dset_args_t *args = (dset_args_t *) malloc(sizeof(dset_args_t));
            args->type_id = dataset_get_type(new_obj->under_object, new_obj->under_vol_id, H5P_DATASET_XFER_DEFAULT, NULL);
            args->space_id = dataset_get_space(new_obj->under_object, new_obj->under_vol_id, H5P_DATASET_XFER_DEFAULT, NULL);
            args->dcpl_id = dataset_get_dcpl(new_obj->under_object, new_obj->under_vol_id, H5P_DATASET_XFER_DEFAULT, NULL);
            args->dapl_id = dataset_get_dapl(new_obj->under_object, new_obj->under_vol_id, H5P_DATASET_XFER_DEFAULT, NULL);
	    args->lcpl_id = H5Pcreate(H5P_LINK_CREATE);
	    args->loc_params = loc_params;
	    args->name = loc_params->loc_data.loc_by_name.name;
	    args->dxpl_id = dxpl_id;

	    new_obj->H5LS->cache_io_cls->create_dataset_cache((void*) new_obj, (void *) args, req);
	    if (getenv("DATASET_PREFETCH_AT_OPEN")) {
 ...
 */
static herr_t
H5VL_cache_ext_object_get(void *obj, const H5VL_loc_params_t *loc_params,
 ...
 */
static herr_t
create_file_cache_on_local_storage(void *obj, void *file_args, void **req) {
...
static herr_t
remove_file_cache_on_local_storage(void *file, void **req) {
  H5VL_cache_ext_t *o = (H5VL_cache_ext_t *)file;
  herr_t ret_value;
  if (o->write_cache) {
    ...
    if (o->H5DWMM->mpi->rank==io_node() && debug_level()>1)
      printf(" [CACHE VOL] Free file io handler\n"); 
    free(o->H5DWMM->io);
    free(o->H5DWMM->mmap); 
    free(o->H5DWMM);
    o->H5DWMM=NULL;
  ...
  if (o->read_cache && (!o->write_cache)) {
    ...
    /* free o->H5DRMM object. Notice that H5DWMM->cache has already been freed in H5LSremove_cache */    
    free(o->H5DRMM->io);
    free(o->H5DRMM->mmap); 
    free(o->H5DRMM);
    o->H5DRMM=NULL;
 ...
 */
static herr_t
create_dataset_cache_on_local_storage(void *obj, void *dset_args, void **req)
{
  ...
  if (dset->read_cache) {
    ...
    if (o->H5DRMM==NULL || o->H5DRMM->cache==NULL) {
      ...
      file_args.fapl_id = file_get_fapl(o->under_object, o->under_vol_id, H5P_DATASET_XFER_DEFAULT, NULL);
	...
	printf(" [CACHE VOL] Unable to allocate space to the dataset for cache; read cache function will be turned off\n");
 ...
 */
static herr_t 
create_group_cache_on_local_storage(void *obj, void *group_args, void **req)
{
#ifdef ENABLE_EXT_CACHE_LOGGING
  ...
  if (group->read_cache) {
	...
	printf(" [CACHE VOL] group cache created: %s\n", group->H5DRMM->cache->path);
    }
  }
 ...
 */
static herr_t 
remove_group_cache_on_local_storage(void *obj, void **req)
{
  H5VL_cache_ext_t *group = (H5VL_cache_ext_t *) obj;
  if (group->read_cache) {
 ...
 */
static herr_t
remove_dataset_cache_on_local_storage(void *dset, void **req)
{
#ifdef ENABLE_EXT_CACHE_LOGGING
    ...
    if (o->write_cache) {
      ...
      double t1 = MPI_Wtime();
      if (debug_level()>1 && o->H5DWMM->mpi->rank == io_node())
	printf(" [CACHE VOL] dataset_wait time: %3.5f\n", t1 - t0);
      o->write_cache=false;
      o->H5DWMM=NULL;
    }
    if (o->read_cache) {
 ...
 */
static herr_t
flush_data_from_local_storage(void *dset, void **req) {
  H5VL_cache_ext_t *o = (H5VL_cache_ext_t *) dset;
 ...
 */
static herr_t
create_file_cache_on_global_storage(void *obj, void *file_args, void **req) {
#ifdef ENABLE_EXT_CACHE_LOGGING
  ...
  if (file->write_cache || file->read_cache) {
    ...
    void *under = H5VLfile_create(file->H5DWMM->mmap->fname, H5F_ACC_TRUNC, args->fcpl_id, fapl_id_default, dxpl_id, req);
    if (under) file->H5DWMM->mmap->obj=H5VL_cache_ext_new_obj(under, async_vol_id);
    if(req && *req)
        *req = H5VL_cache_ext_new_obj(*req, info->under_vol_id);
    if (debug_level()>1 && file->H5DWMM->mpi->rank==io_node())
        printf(" [CACHE VOL] file under_vol_id: %0lx(map), %0lx\n", async_vol_id, file->under_vol_id); 
    file->H5DWMM->io->request_list = (task_data_t*) malloc(sizeof(task_data_t));
...
static herr_t
create_group_cache_on_global_storage(void *obj, void *group_args, void **req) {
  ...
  H5VL_cache_ext_t *pm = (H5VL_cache_ext_t *) p->H5DWMM->mmap->obj; // file object
...
static herr_t
remove_group_cache_on_global_storage(void *obj, void **req) {
#ifdef ENABLE_EXT_CACHE_LOGGING
 ...
 */
static herr_t
create_dataset_cache_on_global_storage(void *obj,  void *dset_args, void **req)
{
  // set up read cache: obj, dset object
  // loc - where is the dataset located - group or file object
  dset_args_t *args = (dset_args_t *) dset_args;
  ...
  if (dset->read_cache || dset->write_cache) {
	...
	printf(" [CACHE VOL] Create dataset in parent group\n"); 
      void *under = H5VLdataset_create(pm->under_object, args->loc_params, pm->under_vol_id, args->name, args->lcpl_id, args->type_id, args->space_id, args->dcpl_id,  args->dapl_id, args->dxpl_id, req);
      if (debug_level()>1 && dset->H5DWMM->mpi->rank==io_node())
	printf(" [CACHE VOL] Create dataset in parent group done\n"); 
      if (under)
	dset->H5DWMM->mmap->obj = H5VL_cache_ext_new_obj(under, pm->under_vol_id); 
 ...
 */
static herr_t
read_data_from_global_storage(void *dset, hid_t mem_type_id, hid_t mem_space_id, hid_t file_space_id, hid_t plist_id, void *buf, void **req)
{
  H5VL_cache_ext_t *o = (H5VL_cache_ext_t *)dset;
  ...
  hid_t dxpl_id = H5Pcreate(H5P_DATASET_XFER);
  H5Pset_plugin_new_api_context(dxpl_id, TRUE);
  herr_t ret_value = H5VLdataset_read(d->under_object, d->under_vol_id, mem_type_id, mem_space_id, file_space_id, dxpl_id, buf, req);
 ...
 */
static herr_t
flush_data_from_global_storage(void *dset, void **req) {
  H5VL_cache_ext_t *o = (H5VL_cache_ext_t *) dset;
  task_data_t *task  = (task_data_t *) o->H5DWMM->io->request_list;
  H5VL_cache_ext_t *d = (H5VL_cache_ext_t *) o->H5DWMM->mmap->obj; 
  ...
  /* Below is to make sure that the data migration will be executed one at a time to prevent memory blow up */
  ...
  o->H5DWMM->io->request_list->next = (task_data_t*) malloc(sizeof(task_data_t));
  o->H5DWMM->io->request_list->next->req = NULL;
  if (o->H5DWMM->mpi->rank==io_node() && debug_level()>0) printf(" [CACHE VOL] added task %d to the list;\n", task->id);
  o->H5DWMM->io->request_list->next->id = o->H5DWMM->io->request_list->id + 1;
  o->H5DWMM->io->request_list = o->H5DWMM->io->request_list->next;
 ...
 */
static herr_t
remove_dataset_cache_on_global_storage(void *dset, void **req)
{
#ifdef ENABLE_EXT_CACHE_LOGGING
    printf("------- EXT CACHE VOL DATASET Cache remove\n");
#endif
...
static herr_t
remove_file_cache_on_global_storage(void *file, void **req) {
  H5VL_cache_ext_t *o = (H5VL_cache_ext_t *)file;
  herr_t ret_value;
  if (o->write_cache) {
    H5VL_cache_ext_file_wait(file);
	...
	/* freeing objects. Notice that H5DWMM->cache was already freed in H5LSremove_cache */
	free(o->H5DWMM->mpi);
	free(o->H5DWMM->mmap);
	free(o->H5DWMM->io); 
	free(o->H5DWMM);
