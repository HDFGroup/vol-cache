...
herr_t H5Fasync_pause(const char *app_file, const char *app_func, unsigned app_line, hid_t file_id);
herr_t H5Fasync_start(const char *app_file, const char *app_func, unsigned app_line, hid_t file_id);
herr_t H5Dcache_remove(const char *app_file, const char *app_func, unsigned app_line, hid_t dset_id);
herr_t H5Dcache_create(const char *app_file, const char *app_func, unsigned app_line, hid_t dset_id, const char *name);
herr_t H5Fcache_create_async(const char *app_file, const char *app_func, unsigned app_line, hid_t file_id, hid_t fapl_id, hsize_t size, cache_purpose_t purpose, cache_duration_t duration, hid_t es_id);
